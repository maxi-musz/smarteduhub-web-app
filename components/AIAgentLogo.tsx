    ...
    <>
      ...
      <div
        ...
        className={cn(
          ...
          sizeClasses[size],
          "bg-gradient-to-r from-primary to-blue-600 p-0.5",
          "shadow-lg hover:shadow-primary/50 transition-shadow",
          className
        )}
      >
        <div className="absolute inset-0 bg-gradient-to-r from-violet-600 to-blue-500 opacity-70 rounded-full blur-md"></div>
        <div
          className={cn(
            "relative flex items-center justify-center w-full h-full bg-background rounded-full z-10",
            isAnimating && "ai-logo-pulse"
          )}
        >
          <svg
            viewBox="0 0 24 24"
          ...
          >
            <defs>
              <linearGradient
                ...
                y2="100%"
              >
                <stop offset="0%" className="logo-gradient" />
                <stop offset="100%" className="logo-gradient-2" />
              </linearGradient>
            </defs>
            <path
